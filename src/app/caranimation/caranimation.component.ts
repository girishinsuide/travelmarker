...
@Component({
  selector: 'app-caranimation',
  templateUrl: './caranimation.component.html',
  styleUrls: ['./caranimation.component.css']
})
...
this.moveIcon();
    ...
    var iconSymbol = {
   // path: 'assets/images/icons/bus.svg',
