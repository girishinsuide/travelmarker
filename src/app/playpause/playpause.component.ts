...
import {Input, Pipe,Component, OnInit, ElementRef ,ViewChild, NgModule, ApplicationRef, ChangeDetectorRef, ComponentFactoryResolver, ComponentRef, Injector, NgZone, EventEmitter} from '@angular/core';
import { TravelMarker, TravelMarkerOptions, TravelData, TravelEvents, EventType, DefaultMarker } from 'travel-marker';
...
@Component({
  ...
  templateUrl: './playpause.component.html',
  styleUrls: ['./playpause.component.css']
})
export class PlaypauseComponent implements OnInit {
  ...
  speedMultiplier = 1;
	...
	//@ViewChild('myRange') elrange:ElementRef;
	@Input() testValue;
...
this.initialize();
  ...
  initialize() {
    var latlng = new google.maps.LatLng(51.512802,-0.091324);
    var mapOpts = {
        center: latlng,
        zoom: 15,
